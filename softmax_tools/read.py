...
def get_softmax_files(base_path, image_base, scalings, header, exclude):
    """
    ...
    :param exclude: list of files that shall not be read
    ...
    for d in directories:
        doc = Document(name=d, tess_base=base_path, image_base=image_base, scalings=scalings, exclude=exclude)
